...
public class Old_MathQuiz extends JFrame {
    ...
    String url = "jdbc:derby://localhost:1527/studentDB";  //url of the DB host
    ...
    private boolean checkName() {
        ...
        try {
            ...
            Logger.getLogger(Old_MathQuiz.class.getName()).log(Level.SEVERE, null, ex);
        }
        return userCheck;
